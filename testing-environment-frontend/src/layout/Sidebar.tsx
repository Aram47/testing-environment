...
export function Sidebar() {
  return (
    <aside className="border-b border-border bg-white md:fixed md:inset-y-0 md:left-0 md:w-64 md:border-b-0 md:border-r">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `focus-ring flex min-h-11 items-center gap-3 rounded-md px-3 text-sm font-medium ${
                isActive ? 'bg-blue-50 text-brand' : 'text-muted hover:bg-slate-50 hover:text-ink'
              }`
            }
          >
